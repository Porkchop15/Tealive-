...
public class EmployeeAttendance extends JFrame {
	...
	public EmployeeAttendance() {
		...
		NewEmployee.setBounds(82, 152, 95, 23);
		contentPane.add(NewEmployee);
		...
		table = new JTable();
		table.setBounds(249, 78, 700, 417);
		contentPane.add(table);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\HP\\Downloads\\6.png"));
